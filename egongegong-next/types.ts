...
// Zendesk Account Configuration
export interface ZendeskAccount {
  id: string;
  name: string; // Display name (e.g., "Brand A Support")
  subdomain: string; // xxx.zendesk.com
  email: string; // Agent email for API auth
...
export interface Brand {
  ...
  name: string;
  logo?: string;
  zendeskAccountId?: string; // Link to ZendeskAccount
}
